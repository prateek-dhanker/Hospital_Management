...
if(isset($_POST['pid'], $_POST['name'], $_POST['age'], $_POST['gender'], $_POST['addres'], $_POST['disease'])){
    ...
    $sql = "INSERT INTO `hospital`.`patients` (`patient_id`, `name`, `age`,`gender`,`adress`,`disease`) VALUES ('$patient_id', '$name', '$age','$gender','$adress','$disease')";
...
<body>
    ...
    <div id="formContent">
        ...
        <div class="message">
            <?php
            if($insert)
                echo "<p id='okmessage'>The data has been saved siccessfully in the database.</p>";
            if($error)
